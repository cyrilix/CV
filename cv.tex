...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\cventry{Nov. 2011\\à Aujourd'hui}{Architecte logiciel}{Bouygues Telecom}{}{}{Architecte logiciel au Middle Office FAI. Mon rôle consite à faire évoluer et maintenir à jour les webservices dédiés à l'acquisition et à la vie cliente sur l'offre internet fixe.\\
...
\begin{item_cv}
    \item \emph{T\^ache:}
            \begin{itemize}%
                ...
                \item harmonisation des développements sur les sytèmes techniques existants
                \item mise en place et administration de l'usine logicielle: jenkins, sonar, gerrit \dots
                \item intervention sur les problèmes de production (fuite mémoire, problèmes de performance, \dots)
                \item d\'eveloppement d'outils de monitoring temps r\'eel de la production
            \end{itemize}
    \item \emph{Technologies:} AOP, glassfish 2 et 3, python, git, gerrit, Jenkins, Sonar, Maven, JAX-WS, REST, JSF2, Spring, Soapui, Junit, Easymock, Selenium, Mongodb, Redis, Oracle, Logback
\end{item_cv}
}
