...
\title{Architecte logiciel / Devops}                               % optional, remove
...
\cvitem{OS}{Linux/UNIX (Debian/Ubuntu, Centos, Solaris)}
\cvitem{Ops}{Ansible, Docker, Letsencrypt}
\cvitem{Langages}{Java, Python, Shell}
\cvitem{Int\'egration continue}{Git, Gerrit, Gitlab, Jenkins, Sonar, Nexus}
\cvitem{J2EE}{Tomcat, Glassfish, JEE, JAX-WS, JAX-RS, Spring, Guice Logback}
\cvitem{NoSQL}{Cassandra, MongoDB, Redis, Elasticsearch}
\cvitem{Base de donn\'ees}{SQL, PostgreSQL/PostGIS, Oracle}
\cvitem{Message Queuing}{AMQP, RabbitMQ, MQTT}
\cvitem{Outils de d\'eveloppement}{Gradle, Maven, Ant, Git, Vim, docker}
\cvitem{Web}{Nginx, Apache}
\cvitem{Auto H\'ebergement}{postfix, dovecot, roundcube, nextcloud}
\cvitem{Autres}{spark, openssl, VirtualBox, LVM, \LaTeX, ssh, iptables, Influxdb/Telegraf} 
...
% Target2sell
\cventry{Déc. 2014\\à aujourd'hui}{Devops}{Target2sell}{}{}{Développement et exploitation d'un moteur de recommendations pour le e-commerce.
\begin{item_cv}
    \item \emph{Dev:} conception et développement des nouvelles fonctionnalités
    \item \emph{Ops:} mise en place, administration et monitoring de l'infrastucture et du produit
    \item \emph{Technologies:} Ansible, Nginx, Docker, Gradle, Datastax Cassandra/Spark, Redis, Mongodb, Rabbitmq, Tomcat, Guice, FluentHttp, Graphite, Grafana, rsyslog
\end{item_cv}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\cventry{Nov. 2011\\à Déc. 2014}{Architecte logiciel transverse Middle Office / SAV Fixe}{Bouygues
...
De mars 2014 à novembre 2014, le périmètre comprend également les applications du Service Après Vente Fixe. Ce périmètre inclut les
technologies php.
\begin{item_cv}
    \item \emph{T\^ache:}
            \begin{itemize}%
...
\section{Activit\'es}
    \cvitem{auto-h\'ebergement}{serveur mail, dnssec, nextcloud, ...}
    \cvitem{Domotique}{IOT, Arduino, RaspberryPi, MQTT}
\clearpage
