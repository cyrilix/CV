...
Telecom}{}{}{Mon rôle consite à faire évoluer et maintenir à jour les webservices dédiés à l'acquisition et à la vie cliente sur l'offre internet fixe.\\
...
\begin{item_cv}
    \item \emph{T\^ache:}
            \begin{itemize}%
                ...
                \item intervention sur les problèmatiques de production complexes (fuites mémoires, problèmes de performance, \dots)
                ...
                \begin{itemize}
                    ...
                    \item le paramètrage des applications
